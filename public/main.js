...
/***/ function(module, exports, __webpack_require__) {
	...
	let SearchBar = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"./searchBar\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
	let SliderBlock = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"./sliderBlock\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
	let AcceptedSet = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"./acceptSet\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
	let Service = __webpack_require__(!(function webpackMissingModule() { var e = new Error("Cannot find module \"./appService\""); e.code = 'MODULE_NOT_FOUND'; throw e; }()));
	...
	let GroupSelectTool = React.createClass({
	    ...
	    onTextChange: function (text) {
	        ...
	        let finish = () => {
	            ...
	            tempSuggestions.sort((a, b) => { return b.score - a.score; });
	            this.setState({
	    ...
	    render: function () {
	        ...
	        return (React.createElement("div", { className: "app col-lg-6 col-lg-offset-3 col-md-8 col-md-offset-2 col-xs-12" },
	            React.createElement(SearchBar, { acceptLease: this.acceptLease, handleTextChange: this.onTextChange, ref: "search" }),
